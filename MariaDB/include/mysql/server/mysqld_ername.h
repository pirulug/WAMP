...
{ "ER_NO", 1002, "NO" },
{ "ER_YES", 1003, "YES" },
{ "ER_CANT_CREATE_FILE", 1004, "Can\'t create file \'%-.200s\' (errno: %iE)" },
{ "ER_CANT_CREATE_TABLE", 1005, "Can\'t create table %sQ.%sQ (errno: %iE)" },
{ "ER_CANT_CREATE_DB", 1006, "Can\'t create database \'%-.192s\' (errno: %iE)" },
...
{ "ER_DB_DROP_DELETE", 1009, "Error dropping database (can\'t delete \'%-.192s\', errno: %iE)" },
{ "ER_DB_DROP_RMDIR", 1010, "Error dropping database (can\'t rmdir \'%-.192s\', errno: %iE)" },
{ "ER_CANT_DELETE_FILE", 1011, "Error on delete of \'%-.192s\' (errno: %iE)" },
{ "ER_CANT_FIND_SYSTEM_REC", 1012, "Can\'t read record in system table" },
{ "ER_CANT_GET_STAT", 1013, "Can\'t get status of \'%-.200s\' (errno: %iE)" },
{ "ER_CANT_GET_WD", 1014, "Can\'t get working directory (errno: %iE)" },
{ "ER_CANT_LOCK", 1015, "Can\'t lock file (errno: %iE)" },
{ "ER_CANT_OPEN_FILE", 1016, "Can\'t open file: \'%-.200s\' (errno: %iE)" },
{ "ER_FILE_NOT_FOUND", 1017, "Can\'t find file: \'%-.200s\' (errno: %iE)" },
{ "ER_CANT_READ_DIR", 1018, "Can\'t read dir of \'%-.192s\' (errno: %iE)" },
{ "ER_CANT_SET_WD", 1019, "Can\'t change dir to \'%-.192s\' (errno: %iE)" },
{ "ER_CHECKREAD", 1020, "Record has changed since last read in table \'%-.192s\'" },
{ "ER_DISK_FULL", 1021, "Disk full (%s); waiting for someone to free some space... (errno: %iE)" },
{ "ER_DUP_KEY", 1022, "Can\'t write; duplicate key in table \'%-.192s\'" },
{ "ER_ERROR_ON_CLOSE", 1023, "Error on close of \'%-.192s\' (errno: %iE)" },
{ "ER_ERROR_ON_READ", 1024, "Error reading file \'%-.200s\' (errno: %iE)" },
{ "ER_ERROR_ON_RENAME", 1025, "Error on rename of \'%-.210s\' to \'%-.210s\' (errno: %iE)" },
{ "ER_ERROR_ON_WRITE", 1026, "Error writing file \'%-.200s\' (errno: %iE)" },
...
{ "ER_GET_ERRNO", 1030, "Got error %iE from storage engine %s" },
{ "ER_ILLEGAL_HA", 1031, "Storage engine %s of the table %sQ.%sQ doesn\'t have this option" },
...
{ "ER_UNEXPECTED_EOF", 1039, "Unexpected EOF found when reading file \'%-.192s\' (errno: %iE)" },
...
{ "ER_BAD_TABLE_ERROR", 1051, "Unknown table \'%-.100sT\'" },
...
{ "ER_BLOB_USED_AS_KEY", 1073, "BLOB column %sQ can\'t be used in key specification in the %s table" },
...
{ "ER_CANT_DROP_FIELD_OR_KEY", 1091, "Can\'t DROP %s %-.192sQ; check that it exists" },
...
{ "ER_WRONG_DB_NAME", 1102, "Incorrect database name \'%-.100sT\'" },
...
{ "ER_CANT_FIND_DL_ENTRY", 1127, "Can\'t find symbol \'%-.128s\' in library \'%-.128s\'" },
...
{ "ER_CANT_CREATE_THREAD", 1135, "Can\'t create a new thread (errno %iE); if you are not out of available memory, you can consult the manual for a possible OS-dependent bug" },
...
{ "ER_TABLEACCESS_DENIED_ERROR", 1142, "%-.100sT command denied to user \'%s\'@\'%s\' for table %sQ.%sQ" },
...
{ "ER_WRONG_KEY_COLUMN", 1167, "The storage engine %s can\'t index column %sQ" },
...
{ "ER_ERROR_DURING_COMMIT", 1180, "Got error %iE during COMMIT" },
{ "ER_ERROR_DURING_ROLLBACK", 1181, "Got error %iE during ROLLBACK" },
{ "ER_ERROR_DURING_FLUSH_LOGS", 1182, "Got error %iE during FLUSH_LOGS" },
{ "ER_ERROR_DURING_CHECKPOINT", 1183, "Got error %iE during CHECKPOINT" },
...
{ "ER_WRONG_VALUE_FOR_VAR", 1231, "Variable \'%-.64s\' can\'t be set to the value of \'%-.200sT\'" },
...
{ "ER_INDEX_CANNOT_HAVE_NULL", 1252, "All parts of a %s index must be NOT NULL" },
...
{ "ER_TRUNCATED_WRONG_VALUE", 1292, "Truncated incorrect %-.32sT value: \'%-.128sT\'" },
...
{ "ER_INVALID_CHARACTER_STRING", 1300, "Invalid %s character string: \'%.64sT\'" },
...
{ "ER_TRUNCATED_WRONG_VALUE_FOR_FIELD", 1366, "Incorrect %-.32s value: \'%-.128sT\' for column `%.192s`.`%.192s`.`%.192s` at row %lu" },
{ "ER_ILLEGAL_VALUE_FOR_TYPE", 1367, "Illegal %s \'%-.192sT\' value found during parsing" },
{ "ER_VIEW_NONUPD_CHECK", 1368, "CHECK OPTION on non-updatable view %-.192sQ.%-.192sQ" },
{ "ER_VIEW_CHECK_FAILED", 1369, "CHECK OPTION failed %-.192sQ.%-.192sQ" },
...
{ "ER_NO_FILE_MAPPING", 1388, "Can\'t map file: %-.200s, errno: %iE" },
...
{ "ER_WRONG_VALUE_FOR_TYPE", 1411, "Incorrect %-.32s value: \'%-.128sT\' for function %-.32s" },
...
{ "ER_TABLE_NEEDS_UPGRADE", 1459, "Upgrade required. Please do \"REPAIR %s %sQ\" or dump/reload to fix it!" },
...
{ "ER_VIEW_RECURSIVE", 1462, "%sQ.%sQ contains view recursion" },
...
{ "ER_WRONG_STRING_LENGTH", 1470, "String \'%-.70sT\' is too long for %s (should be no longer than %d)" },
...
{ "ER_WRONG_VALUE", 1525, "Incorrect %-.32s value: \'%-.128sT\'" },
...
{ "ER_EVENT_STORE_FAILED", 1538, "Failed to store event %s. Error code %iE from storage engine" },
...
{ "ER_DUP_ENTRY_AUTOINCREMENT_CASE", 1569, "ALTER TABLE causes auto_increment resequencing, resulting in duplicate entry \'%-.192sT\' for key \'%-.192s\'" },
{ "ER_EVENT_MODIFY_QUEUE_ERROR", 1570, "Internal scheduler error %d" },
{ "ER_EVENT_SET_VAR_ERROR", 1571, "Error during starting/stopping of the scheduler. Error code %iE" },
...
{ "ER_DUP_ENTRY_WITH_KEY_NAME", 1586, "Duplicate entry \'%-.64sT\' for key \'%-.192s\'" },
...
{ "ER_VIEW_NO_CREATION_CTX", 1599, "View %sQ.%sQ has no creation context" },
{ "ER_VIEW_INVALID_CREATION_CTX", 1600, "Creation context of view %sQ.%sQ is invalid" },
{ "ER_SR_INVALID_CREATION_CTX", 1601, "Creation context of stored routine %sQ.%sQ is invalid" },
{ "ER_TRG_CORRUPTED_FILE", 1602, "Corrupted TRG file for table %sQ.%sQ" },
{ "ER_TRG_NO_CREATION_CTX", 1603, "Triggers for table %sQ.%sQ have no creation context" },
{ "ER_TRG_INVALID_CREATION_CTX", 1604, "Trigger creation context of table %sQ.%sQ is invalid" },
{ "ER_EVENT_INVALID_CREATION_CTX", 1605, "Creation context of event %sQ.%sQ is invalid" },
{ "ER_TRG_CANT_OPEN_TABLE", 1606, "Cannot open table for trigger %sQ.%sQ" },
{ "ER_CANT_CREATE_SROUTINE", 1607, "Cannot create stored routine %sQ. Check warnings" },
...
{ "ER_PATH_LENGTH", 1680, "The path specified for %.64sT is too long" },
...
{ "ER_TABLE_NEEDS_REBUILD", 1707, "Table rebuild required. Please do \"ALTER TABLE %sQ FORCE\" or dump/reload to fix it!" },
...
{ "ER_VERS_NOT_ALLOWED", 1726, "Not allowed for system-versioned table %sQ.%sQ" },
...
{ "ER_NO_INDEX_ON_TEMPORARY", 1796, "Cannot create %s index on temporary %s table" },
...
{ "ER_TABLESPACE_DISCARDED", 1814, "Tablespace has been discarded for table %sQ" },
...
{ "ER_DUP_INDEX", 1831, "Duplicate index %sQ. This is deprecated and will be disallowed in a future release" },
...
{ "ER_GENERATED_COLUMN_FUNCTION_IS_NOT_ALLOWED", 1901, "Function or expression \'%s\' cannot be used in the %s clause of %sQ" },
...
{ "ER_BAD_OPTION_VALUE", 1912, "Incorrect value \'%-.64sT\' for option \'%-.64s\'" },
...
{ "ER_SQL_DISCOVER_ERROR", 1939, "Engine %s failed to discover table %-.192sQ.%-.192sQ with \'%s\'" },
...
{ "ER_INVALID_ROLE", 1959, "Invalid role specification %sQ" },
...
{ "ER_TABLE_DEFINITION_TOO_BIG", 1967, "The definition for table %sQ is too big" },
...
{ "ER_INVALID_DEFAULT_VALUE_FOR_FIELD", 1978, "Incorrect default value \'%-.128sT\' for column \'%.192s\'" },
...
{ "ER_DUP_QUERY_NAME", 4004, "Duplicate query name %-.64sQ in WITH clause" },
...
{ "ER_CONSTRAINT_FAILED", 4025, "CONSTRAINT %sQ failed for %-.192sQ.%-.192sQ" },
...
{ "ER_CALCULATING_DEFAULT_VALUE", 4028, "Got an error when calculating default value for %sQ" },
{ "ER_EXPRESSION_REFERS_TO_UNINIT_FIELD", 4029, "Expression for field %-.64sQ is referring to uninitialized field %sQ" },
...
{ "ER_SLAVE_SAME_ID", 4052, "A slave with the same server_id as this slave has connected to the master" },
...
{ "ER_PACKAGE_ROUTINE_IN_SPEC_NOT_DEFINED_IN_BODY", 4095, "%s %sQ is declared in the package specification but is not defined in the package body" },
{ "ER_PACKAGE_ROUTINE_FORWARD_DECLARATION_NOT_DEFINED", 4096, "%s %sQ has a forward declaration but is not defined" },
...
{ "ER_INVISIBLE_NOT_NULL_WITHOUT_DEFAULT", 4108, "Invisible column %sQ must have a default value" },
{ "ER_UPDATE_INFO_WITH_SYSTEM_VERSIONING", 4109, "Rows matched: %ld  Changed: %ld  Inserted: %ld  Warnings: %ld" },
{ "ER_VERS_FIELD_WRONG_TYPE", 4110, "%sQ must be of type %s for system-versioned table %sQ" },
{ "ER_VERS_ENGINE_UNSUPPORTED", 4111, "Transaction-precise system versioning for %sQ is not supported" },
{ "ER_WRONG_VERSIONING_RANGE", 4112, "Incorrect system-version range \'%-.32s\' value: \'%-.128sT\' and \'%-.32s\' value: \'%-.128sT\'" },
{ "ER_PARTITION_WRONG_TYPE", 4113, "Wrong partition type %sQ for partitioning by %sQ" },
{ "WARN_VERS_PART_FULL", 4114, "Versioned table %sQ.%sQ: last HISTORY partition (%sQ) is out of %s, need more HISTORY partitions" },
...
{ "WARN_VERS_PART_NON_HISTORICAL", 4118, "Partition %sQ contains non-historical data" },
{ "ER_VERS_ALTER_NOT_ALLOWED", 4119, "Not allowed for system-versioned %sQ.%sQ. Change @@system_versioning_alter_history to proceed with ALTER." },
{ "ER_VERS_ALTER_ENGINE_PROHIBITED", 4120, "Not allowed for system-versioned %sQ.%sQ. Change to/from native system versioning engine is not supported." },
...
{ "ER_VERS_TABLE_MUST_HAVE_COLUMNS", 4123, "Table %sQ must have at least one versioned column" },
{ "ER_VERS_NOT_VERSIONED", 4124, "Table %sQ is not system-versioned" },
{ "ER_MISSING", 4125, "Wrong parameters for %sQ: missing \'%s\'" },
{ "ER_VERS_PERIOD_COLUMNS", 4126, "PERIOD FOR SYSTEM_TIME must use columns %sQ and %sQ" },
{ "ER_PART_WRONG_VALUE", 4127, "Wrong parameters for partitioned %sQ: wrong value for \'%s\'" },
{ "ER_VERS_WRONG_PARTS", 4128, "Wrong partitions for %sQ: must have at least one HISTORY and exactly one last CURRENT" },
{ "ER_VERS_NO_TRX_ID", 4129, "TRX_ID %llu not found in `mysql.transaction_registry`" },
{ "ER_VERS_ALTER_SYSTEM_FIELD", 4130, "Can not change system versioning field %sQ" },
{ "ER_DROP_VERSIONING_SYSTEM_TIME_PARTITION", 4131, "Can not DROP SYSTEM VERSIONING for table %sQ partitioned BY SYSTEM_TIME" },
{ "ER_VERS_DB_NOT_SUPPORTED", 4132, "System-versioned tables in the %sQ database are not supported" },
{ "ER_VERS_TRT_IS_DISABLED", 4133, "Transaction registry is disabled" },
{ "ER_VERS_DUPLICATE_ROW_START_END", 4134, "Duplicate ROW %s column %sQ" },
{ "ER_VERS_ALREADY_VERSIONED", 4135, "Table %sQ is already system-versioned" },
...
{ "ER_UPDATED_COLUMN_ONLY_ONCE", 4140, "The column %sQ.%sQ cannot be changed more than once in a single UPDATE statement" },
{ "ER_EMPTY_ROW_IN_TVC", 4141, "Row with no elements is not allowed in table value constructor in this context" },
{ "ER_VERS_QUERY_IN_PARTITION", 4142, "SYSTEM_TIME partitions in table %sQ does not support historical query" },
{ "ER_KEY_DOESNT_SUPPORT", 4143, "%s index %sQ does not support this operation" },
...
{ "ER_PERIOD_TYPES_MISMATCH", 4153, "Fields of PERIOD FOR %sQ have different types" },
{ "ER_MORE_THAN_ONE_PERIOD", 4154, "Cannot specify more than one application-time period" },
{ "ER_PERIOD_FIELD_WRONG_ATTRIBUTES", 4155, "Period field %sQ cannot be %s" },
{ "ER_PERIOD_NOT_FOUND", 4156, "Period %sQ is not found in table" },
{ "ER_PERIOD_COLUMNS_UPDATED", 4157, "Column %sQ used in period %sQ specified in update SET list" },
...
{ "ER_SP_DUP_DECL", 4163, "Duplicate declaration: \'%-.64s\'" },
{ "ER_PART_STARTS_BEYOND_INTERVAL", 4164, "%sQ: STARTS is later than query time, first history partition may exceed INTERVAL value" },
...
{ "ER_NO_AUTOINCREMENT_WITH_UNIQUE", 4169, "AUTO_INCREMENT column %sQ cannot be used in the UNIQUE index %sQ" },
{ "ER_KEY_CONTAINS_PERIOD_FIELDS", 4170, "Key %sQ cannot explicitly include column %sQ" },
{ "ER_KEY_CANT_HAVE_WITHOUT_OVERLAPS", 4171, "Key %sQ cannot have WITHOUT OVERLAPS" },
...
{ "ER_VERS_HIST_PART_FAILED", 4189, "Versioned table %sQ.%sQ: adding HISTORY partition(s) failed" },
...
{ "ER_PSEUDO_THREAD_ID_OVERWRITE", 4196, "Pseudo thread id should not be modified by the client as it will be overwritten" },
{ "ER_SEQUENCE_TABLE_HAS_WRONG_NUMBER_OF_COLUMNS", 4197, "Wrong number of columns" },
{ "ER_SEQUENCE_TABLE_CANNOT_HAVE_ANY_KEYS", 4198, "Sequence tables cannot have any keys" },
{ "ER_SEQUENCE_TABLE_CANNOT_HAVE_ANY_CONSTRAINTS", 4199, "Sequence tables cannot have any constraints" },
{ "ER_SEQUENCE_TABLE_ORDER_BY", 4200, "ORDER BY" },
{ "ER_VARIABLE_IGNORED", 4201, "The variable \'%s\' is ignored. It only exists for compatibility with old installations and will be removed in a future release" },
{ "ER_INCORRECT_COLUMN_NAME_COUNT", 4202, "Incorrect column name count for derived table" },
{ "WARN_SORTING_ON_TRUNCATED_LENGTH", 4203, "%llu values were longer than max_sort_length. Sorting used only the first %lu bytes" },
{ "ER_VECTOR_BINARY_FORMAT_INVALID", 4204, "Invalid binary vector format. Must use IEEE standard float representation in little-endian format. Use VEC_FromText() to generate it." },
{ "ER_VECTOR_FORMAT_INVALID", 4205, "Invalid vector format at offset: %d for \'%-.100s\'. Must be a valid JSON array of numbers." },
{ "ER_VEC_DISTANCE_TYPE", 4206, "Cannot determine distance type for VEC_DISTANCE, index is not found" },
{ "WARN_INDEX_HINTS_IGNORED", 4207, "Index hints are ignored because they are incompatible with RETURNING clause" },
{ "ER_SIGNAL_SKIP_ROW_FROM_TRIGGER", 4208, "The row is skipped by a trigger implementation" },
